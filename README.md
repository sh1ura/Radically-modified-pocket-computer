...
* bluetoothキーボード機能を搭載(ESP32)
  - <a href="https://x.com/shiura/status/1997224685965336579">Linux の GUI 画面への文字入力（VNCやHDMIディスプレイの接続時）</a>に利用可能
  - 電卓モードでは<a href="https://x.com/shiura/status/1997232332638740924">計算結果の転送</a>も可能
