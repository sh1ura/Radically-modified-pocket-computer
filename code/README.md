...
* [設定画面（GUI の「設定」、または CLI の raspi-config）で、シリアルポート有効、シリアルコンソール有効にセット](https://toki-blog.com/pi-serial/)してください。
* デフォルトで、GPIO14/15 にログインプロンプトが出るようになります（起動時・シャットダウン時のメッセージも表示されます）。
